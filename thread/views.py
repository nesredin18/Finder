...
from .serializer import lostpSerializer,lostiSerializer,foundiSerializer,foundpSerializer,accountSerializer,registerserializer,loginSerializer
from .models import lost_P,found_P,lost_i,found_i,account,person_type
...
def createlostp(request):
    ...
    lostp=lost_P.objects.create(
        ...
        detail=data['detail'],
        adress=data['address'],
        p_type=person_type.objects.get(id=pk),
    )
